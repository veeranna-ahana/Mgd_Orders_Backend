                                            ...
                                            if (err) {
                                                ...
                                                misQueryMod(deleteQuery, (err, result4) => {
                                                    if (err) {
                                                        ...
                                                        return res.status(200).send("Schedules cancelled successfully");
                                                    }
                                                });
                                            }
                                        });
