...
scheduleListCombined.get('/ScheduleListOrdered', jsonParser, async (req, res, next) => {
  ...
  scheduleListCombined.get('/ScheduleListClosed', jsonParser, async (req, res, next) => {
    try {
  ...
  scheduleListCombined.get('/ScheduleListClosedSales', jsonParser, async (req, res, next) => {
    try {
  ...
  scheduleListCombined.post('/combinedTaksTaskTable', jsonParser, async (req, res, next) => {
    try {
  ...
  scheduleListCombined.post('/combinedTaksShowDwgName', jsonParser, async (req, res, next) => {
  ...
  scheduleListCombined.post('/OriginalTable1', jsonParser, async (req, res, next) => {
...
scheduleListCombined.post('/OriginalTable2', jsonParser, async (req, res, next) => {
